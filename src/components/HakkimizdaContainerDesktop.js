    ...
    <div className="flex">
      <div className={`${props.direction === "right" ? "order-1" : "order-2"} flex flex-col w-1/2 py-20 md:py-40 px-6 xl:px-20`}>
        <div className="flex flex-col mb-8">
          <h1 className="text-4xl text-transparent bg-clip-text bg-gradient-to-l from-white_200 via-gray to-gold_100">{props.h1}</h1>
          <h1 className="text-4xl text-transparent bg-clip-text bg-gradient-to-r from-white_200 via-gray to-gold_100">{props.h1_side}</h1>
        </div>
