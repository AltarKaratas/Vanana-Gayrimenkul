...
const Landing = (props) => {
  ...
  return (
    <section
      className={`${calculatedHeight} pt-16 lg:pt-20  sm:landscape:min-h-[540px]  flex justify-center items-end bg-gradient-to-b from-[#0a0a0a] to-[#171717] min-h-[540px]`}
    >
      ...
      <div className="relative h-full w-full flex flex-col items-center pt-6 md:pt-12">
        <div className="relative z-30 mt-[10vh] md:mt-[12vh] lg:mt-[10vh]  h-[15dvw] sm:h-[100px] md:h-[120px] lg:h-[200px] 2xl:h-[250px] w-[290px] sm:w-[540px] md:w-[640px] lg:w-[720px] xl:w-[960px] 2xl:w-[1150px] ">
          <Image
        ...
        <div className="flex relative h-full w-full flex-col items-center justify-end">
          ...
          <div className="relative h-[40vh] md:h-[60vh] lg:h-[70vh] w-[270px] sm:w-[320px] md:w-[400px]  lg:w-[480px]">
            <Image
              src="/ARP KULE1.png"
              alt=""
              fill
          ...
          <div className="absolute z-40 h-full w-[100dvw]">
            {screenSize.width >= 768 && (
