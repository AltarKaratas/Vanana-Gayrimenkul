...
export default function GridItem(props) {
  return (
    ...
    >
      ...
      <div className="h-3/4 relative z-10 w-full flex flex-col justify-between  px-3 lg:px-6 py-4  bg-gradient-to-r from-black_100 via-black_100 to-black_200 overflow-hidden ">
        <h3 className="relative py-2 w-full z-10 font-inter  text-2xl md:text-3xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-r from-white_200 to-gray  border-b-4 border-gold_100  ">
          {props.title}
        </h3>
        <p className="text-white h-full font-light pt-2 ">{props.text}</p>
      </div>
    </div>
  );
}
